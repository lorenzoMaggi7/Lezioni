...
class Libro:
    ...
    def __init__(self, titolo: str, autore: str, stato: bool) -> None:
        pass
...
class Biblioteca:
    ...
    def aggiungi_libro(libro:Libro):
        return f"Il libro: {libro} è stato aggiunto"
        pass

    def presta_libro(titolo: Libro):
        if titolo in Libro:
            return f"{titolo} disponibile"
        else:
            return "non disponibile"
        pass
    def restituisci_libro(titolo):
        if titolo in Libro:
            return f"il libro: {titolo} è stato restituito"
        else:
            return "libro non restituibile"
        pass
